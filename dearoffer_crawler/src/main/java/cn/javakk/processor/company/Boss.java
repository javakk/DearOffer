package cn.javakk.processor.company;
...
import cn.javakk.util.JsonFilePipeline;
...
//                page.putField("registerPerson", person);
//                page.putField("registerMoney", registerMoney);
//                page.putField("registerTime", dateTime);
//                page.putField("companyType", companyType);
//                page.putField("companyStatus", companyStatus);
//                page.putField("address", registerAddress);
//                page.putField("registerCode", companyCode);
//                page.putField("sellScale", sellScale);
//
//                page.putField("createDate", new Date());

                String[] split = page.getUrl().toString().split("/");
                String companyId = split[4].substring(0, split[4].length() - 5);
//                page.putField("source", companyId);
